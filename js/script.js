...
//Fanzines//
    ...
    const fanzines = [fanzine1, fanzine2, fanzine3, fanzine4,fanzine5]
...
//Apparel//
    ...
    const apparel = [apparel1, apparel2, apparel3, apparel4]
    console.log(apparel)
...
//Misc Items//
    ...
    const misc = [misc1, misc2, misc3, misc4, misc5]
    console.log(misc)
...
//Prints//
    ...
    const fineArtPrints = [fineArtPrint1, fineArtPrint2, fineArtPrint3, fineArtPrint4]
    const holoPrints = [holoPrint1]
    const screenPrints = [screenPrint1, screenPrint2]
    const prints = [fineArtPrints, holoPrints, screenPrints]
    console.log(prints)

    const storeFull = [fanzines, apparel, misc, prints]
